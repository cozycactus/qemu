                                       ...
                                       int n)
{
    ...
    if ((ctx->bytes[0] & AVR32_EXTENDED_INSTR_FORMAT_MASK_LE) ==
        AVR32_EXTENDED_INSTR_FORMAT_MASK_LE) {
...
#define output(mnemonic, format, ...)                                          \
    (pctx->dis->fprintf_func(pctx->dis->stream, "%-9s " format, mnemonic,      \
                             ##__VA_ARGS__))
...
INSN(ADD_cond, ADD_cond, "%s, %s, [0x%04x], %s", REG(a->rx), REG(a->ry),
     a->cond, REG(a->rd))
INSN(ADDABS, ADDABS, "%s, %s, %s", REG(a->rd), REG(a->rx), REG(a->ry))
INSN(ADDHHW, ADDHHW, "%s, %s, %s, %s, %s", REG(a->rd), REG(a->rx), REG(a->x),
     REG(a->y), REG(a->rd))

INSN(AND_f1, AND, "%s, %s", REG(a->rd), REG(a->rs))
INSN(AND_f2, AND, "%s, %s, %s, 02%04x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa5)
INSN(AND_f3, AND, "%s, %s, %s, 02%04x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa5)
INSN(AND_cond, AND, "%s, %s, [0x%04x], %s", REG(a->rx), REG(a->ry), a->cond,
     REG(a->rd))
...
INSN(BFEXTS, BFEXTS, "%s, %s, [0x%04x], [0x%04x]", REG(a->rd), REG(a->rs),
     a->bp5, a->w5)
INSN(BFEXTU, BFEXTU, "%s, %s, [0x%04x], [0x%04x]", REG(a->rd), REG(a->rs),
     a->bp5, a->w5)
INSN(BFINS, BFINS, "%s, %s, [0x%04x], [0x%04x]", REG(a->rd), REG(a->rs), a->bp5,
     a->w5)

INSN(BLD, BLD, "%s, 0x%04x", REG(a->rd), a->bp5)

INSN(BR_f1, BR, "cond3{%d}, disp: [0x%04x]", a->rd, (a->disp))
INSN(BR_f2, BR, "cond4{%d}, disp2: [0x%04x], disp1: [0x%02x], disp0: [0x%04x]",
     a->cond, a->disp2, a->disp1, a->disp0)
...
INSN(EOR_cond, EOR, "%s, %s, %s, %d", REG(a->rd), REG(a->rx), REG(a->ry),
     a->cond)
...
INSN(LDSH_f5, LDSH, "%s, %s, %s, 0x%02x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa);
...
INSN(LDW_cond, LDWc, "%s, %s, 0x%04x, 0x%04x", REG(a->rp), REG(a->rd), a->cond4,
     a->disp9)

INSN(LDDPC, LDDPC, "%s, PC[0x%04x]", REG(a->rd), a->disp << 2)
INSN(LDDSP, LDDSP, "%s, %d", REG(a->rd), a->disp << 2)

INSN(LDINSB, LDINSB, "%s, %s, 0x%02x, 0x%04x", REG(a->rd), REG(a->rp), a->part,
     a->disp12)
INSN(LDINSH, LDINSB, "%s, %s, 0x%02x, 0x%04x", REG(a->rd), REG(a->rp), a->part,
     a->disp12)
...
INSN(OR_f2, OR, "%s, %s, %s, 0x%04x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa5)
INSN(OR_f3, OR, "%s, %s, %s, 0x%04x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa5)
INSN(OR_cond, OR, "%s, %s, %s, 0x%x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->cond4)
...
INSN(STB_f5, STB, "%s, %s, %s, 0x%02x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa)
...
INSN(STH_f5, STH, "%s, %s, %s, 0x%02x", REG(a->rd), REG(a->rx), REG(a->ry),
     a->sa)
...
INSN(STWcond, STWc, "%s, %s, %d, 0x%04x", REG(a->rd), REG(a->rp), a->cond4,
     a->disp9)
